...
masterAdminSchema.pre('updateOne', function(next) {
  ...
  if ((update.$set && update.$set.budget !== undefined) || (update.$set && update.$set.allotedBudget !== undefined)) {
    // Calculate the updated availableBudget
    const newBudget = update.$set.budget !== undefined ? update.$set.budget : this.budget;
    const newAllotedBudget = update.$set.allotedBudget !== undefined ? update.$set.allotedBudget : this.allotedBudget;
